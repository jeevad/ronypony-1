    ...
    */
    ...
    'custom' => [
        ...
        'first_name' => [
            ...
            'min' => 'Your first name may not be less than 3 characters.',
            'max' => 'Your first name may not be greater than 50 characters.',
        ],
        'last_name' => [
            'required' => 'Last name can not be blank',
            'first_name' => 'Invalid last name',
            'min' => 'Your last name may not be less than 1 characters.',
            'max' => 'Your last name may not be greater than 50 characters.',
        ],
        'office_name' => [
            'required' => 'Office name can not be blank',
            'office_name' => 'Invalid office name',
            'min' => 'Office name may not be less than 3 characters.',
            'max' => 'Office name may not be greater than 50 characters.',
        ],
        'locality' => [
            'required' => 'Locality name can not be blank',
            'locality' => 'Invalid locality',
            'min' => 'Locality may not be less than 3 characters.',
            'max' => 'Locality may not be greater than 100 characters.',
        ],
        'address' => [
            'required' => 'Address can not be blank',
            'address' => 'Invalid address',
            'min' => 'address may not be less than 10 characters.',
            'max' => 'address name may not be greater than 250 characters.',
        ],
        'landmark' => [
            'required' => 'Lankmark can not be blank',
            'landmark' => 'Invalid lankmark',
