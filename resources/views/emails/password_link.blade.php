                        ...
                        <div
                            ...
                            <table style="padding: 0; border: 0; width: 100%;">
                                <tr>
                                    <td>
                                        <h3
                                                style="margin: 10px 0; font-size: 14px; color: #808080; font-weight: bold; text-align: center; line-height: 40px;">
                                        ...
                                        <div>
                                            If above button didn't work, please paste below URL in your favourite
                                            browser
                                            <a href="{{ $action }}" target="_blank">
                                                {{$action}}
                                            </a>
