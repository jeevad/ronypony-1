...
@include('admin.forms.file',['name' => 'downloadable[demo_product]','label' => 'Demo Product (If any)'])
...
@include('admin.forms.file',['name' => 'downloadable[main_product]','label' => 'Main Product'])
