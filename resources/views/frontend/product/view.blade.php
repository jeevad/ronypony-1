...
<div class="container-fluid">
    <div class="row">
        <div class="col-4">
            @include('frontend.product.view.product-image',['imageType' => 'largeUrl','extraImage' => true])
        </div>
        ...
        <div class="col-8">
            ...
            @if($product->type == 'BASIC')
                @include('frontend.product.view.type.basic-add-to-cart')
            @endif

            @if($product->type == 'VARIATION' )
                @include('frontend.product.view.type.variation-add-to-cart')
            @endif

            @if($product->type == 'DOWNLOADABLE' )
                @include('frontend.product.view.type.downloadable-add-to-cart')
            @endif
    ...
    <div class="col-12">
        ...
        <div class="tab-content">
            ...
            {{-- <div class="tab-pane" id="reviews" role="tabpanel" aria-labelledby="reviews-tab">
                <p>@include("frontend.product.review")</p>
            </div> --}}
        ...
        <!-- include("frontend.related.product.list") -->
