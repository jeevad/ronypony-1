...
use Jcart\Framework\Shipping\Facade as ShippingFacade;
...
class Provider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->alias('shipping', 'Jcart\Framework\Shipping\Manager');
    }
    ...
    {
        return ['shipping', 'Jcart\Framework\Shipping\Manager'];
    }
