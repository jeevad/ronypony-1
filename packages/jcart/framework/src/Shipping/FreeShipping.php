...
use Jcart\Framework\Shipping\Shipping as AbstractShipping;
use Jcart\Framework\Shipping\Contracts\Shipping as ShippingContract;
...
class FreeShipping extends AbstractShipping implements ShippingContract
{
     ...
     * @var string
     */
    protected $view = 'jcart-framework::shipping.free-shipping';
