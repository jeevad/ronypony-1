...
use Jcart\Framework\Permission\Facade as PermissionFacade;
...
class Provider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->singleton('permission', 'Jcart\Framework\Permission\Manager');
    }
    ...
    {
        return ['permission', 'Jcart\Framework\Permission\Manager'];
    }
